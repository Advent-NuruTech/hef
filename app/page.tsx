...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-blue-50/40 to-gray-50 text-gray-800">
      {/* ================= HERO SECTION ================= */}
   <section className="relative text-center py-16 px-6 md:px-12 bg-gradient-to-r from-blue-800 via-sky-600 to-blue-900 text-white rounded-b-3xl shadow-lg">
      ...
      {/* ================= CONTACT SECTION ================= */}
      <section className="py-16 px-6 md:px-12 bg-gradient-to-r from-sky-50 to-blue-100 text-center rounded-t-3xl">
        ...
        <Link href="/contact">
          <motion.button
            ...
            className="px-8 py-3 bg-blue-700 text-white rounded-full shadow-lg hover:bg-blue-800 transition-colors"
          >
            Contact Us
          </motion.button>
        </Link>
  ...
  const content = (
    <motion.h2
      className="text-4xl font-extrabold tracking-tight text-transparent bg-clip-text 
                 bg-gradient-to-r from-blue-700 via-sky-500 to-blue-600 animate-gradient-x 
...
function UniformCard({ title, desc, link }: { title: string; desc: string; link: string }) {
  return (
    <Link href={link}>
      <motion.div
        whileHover={{ y: -5 }}
        className="p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all border border-blue-100"
      >
